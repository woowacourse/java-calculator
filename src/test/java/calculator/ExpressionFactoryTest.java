...
public class ExpressionFactoryTest {
    ...
    void create_Should_NullPointerException_When_InputStringIsNull() {
    ...
    void create_ConsecutiveSpace_IllegalArgumentException(String input) {
    ...
    void create_InvalidToken_IllegalArgumentException() {
    ...
    void create_ConsecutiveOperator_NumberFormatException() {
    ...
    void create_ConsecutiveNumber_IllegalArgumentException() {
